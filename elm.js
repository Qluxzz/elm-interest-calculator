...
var $author$project$Main$Model = F6(
	function (key, url, yearlyInterest, monthlySavings, start, years) {
		return {key: key, monthlySavings: monthlySavings, start: start, url: url, yearlyInterest: yearlyInterest, years: years};
	});
var $author$project$Main$default = F2(
	function (key, url) {
		return A6($author$project$Main$Model, key, url, 7, 1000, 10000, 20);
	});
...
var $author$project$Main$Query = F4(
	function (monthlySavings, years, interest, start) {
		return {interest: interest, monthlySavings: monthlySavings, start: start, years: years};
	});
...
var $author$project$Main$interestQueryParam = 'interest';
...
var $author$project$Main$montlySavingsQueryParam = 'monthlySavings';
...
var $author$project$Main$startingSavingsQueryParam = 'start';
var $author$project$Main$yearsQueryParam = 'years';
var $author$project$Main$parseSharedUrl = $elm$url$Url$Parser$query(
	A5(
		$elm$url$Url$Parser$Query$map4,
		$author$project$Main$Query,
		$elm$url$Url$Parser$Query$int($author$project$Main$montlySavingsQueryParam),
		$elm$url$Url$Parser$Query$int($author$project$Main$yearsQueryParam),
		$elm$url$Url$Parser$Query$int($author$project$Main$interestQueryParam),
		$elm$url$Url$Parser$Query$int($author$project$Main$startingSavingsQueryParam)));
var $author$project$Main$getSettingsFromQuery = F2(
	function (key, url) {
		var maybeSettings = A2($elm$url$Url$Parser$parse, $author$project$Main$parseSharedUrl, url);
		if (maybeSettings.$ === 'Just') {
			var settings = maybeSettings.a;
			return A6(
				$author$project$Main$Model,
				key,
				url,
				A2($elm$core$Maybe$withDefault, 7, settings.interest),
				A2($elm$core$Maybe$withDefault, 1000, settings.monthlySavings),
				A2($elm$core$Maybe$withDefault, 10000, settings.start),
				A2($elm$core$Maybe$withDefault, 20, settings.years));
		} else {
			return A2($author$project$Main$default, key, url);
		}
	});
var $author$project$Main$init = F3(
	function (_v0, url, key) {
		return _Utils_Tuple2(
			A2($author$project$Main$getSettingsFromQuery, key, url),
			$elm$core$Platform$Cmd$none);
	});
...
var $author$project$Main$shareUrl = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				A2($elm$url$Url$Builder$int, $author$project$Main$interestQueryParam, model.yearlyInterest),
				A2($elm$url$Url$Builder$int, $author$project$Main$montlySavingsQueryParam, model.monthlySavings),
				A2($elm$url$Url$Builder$int, $author$project$Main$startingSavingsQueryParam, model.start),
				A2($elm$url$Url$Builder$int, $author$project$Main$yearsQueryParam, model.years)
			]));
};
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'UrlChanged':
				var url = msg.a;
				return _Utils_Tuple2(
					A2($author$project$Main$getSettingsFromQuery, model.key, url),
					$elm$core$Platform$Cmd$none);
			case 'Share':
				return _Utils_Tuple2(
					model,
			...
			default:
				var defaultModel = A2($author$project$Main$default, model.key, model.url);
				return _Utils_Tuple2(
					defaultModel,
					A2(
						$elm$browser$Browser$Navigation$replaceUrl,
						model.key,
						$author$project$Main$shareUrl(defaultModel)));
		}
	});
var $author$project$Main$Reset = {$: 'Reset'};
var $author$project$Main$Share = {$: 'Share'};
var $author$project$Main$UpdateMonthlySavings = function (a) {
	return {$: 'UpdateMonthlySavings', a: a};
};
var $author$project$Main$UpdateStartbelopp = function (a) {
	return {$: 'UpdateStartbelopp', a: a};
};
var $author$project$Main$UpdateYearlyInterest = function (a) {
	return {$: 'UpdateYearlyInterest', a: a};
};
var $author$project$Main$UpdateYears = function (a) {
	return {$: 'UpdateYears', a: a};
};
...
var $author$project$Main$defaultToZero = A2(
	$elm$core$Basics$composeR,
	$elm$core$String$toInt,
...
var $author$project$Main$intValue = A2($elm$core$Basics$composeR, $elm$core$String$fromInt, $rtfeldman$elm_css$Html$Styled$Attributes$value);
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('Ränta på ränta')
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$Attributes$for('interest')
									]),
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text('Ränta per år (%)')
									])),
								A2(
								...
								_List_fromArray(
									[
										...
										$rtfeldman$elm_css$Html$Styled$Attributes$max('25'),
										$author$project$Main$intValue(model.yearlyInterest),
										$rtfeldman$elm_css$Html$Styled$Events$onInput(
										function (v) {
											return $author$project$Main$UpdateYearlyInterest(
												$author$project$Main$defaultToZero(v));
										})
									]),
								_List_Nil),
								A2(
								...
								_List_fromArray(
									[
										...
										$elm$core$String$fromInt(model.yearlyInterest))
									]))
							])),
						A2(
						$rtfeldman$elm_css$Html$Styled$div,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$Attributes$for('monthly-savings')
									]),
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text('Månadssparande')
									])),
								A2(
								$rtfeldman$elm_css$Html$Styled$input,
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$Attributes$type_('range'),
										$rtfeldman$elm_css$Html$Styled$Attributes$min('0'),
										$rtfeldman$elm_css$Html$Styled$Attributes$max('20000'),
										$rtfeldman$elm_css$Html$Styled$Attributes$step('100'),
										$author$project$Main$intValue(model.monthlySavings),
										$rtfeldman$elm_css$Html$Styled$Events$onInput(
										function (v) {
											return $author$project$Main$UpdateMonthlySavings(
												$author$project$Main$defaultToZero(v));
										})
									]),
								_List_Nil),
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text(
										$elm$core$String$fromInt(model.monthlySavings))
									]))
							])),
						A2(
						$rtfeldman$elm_css$Html$Styled$div,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$Attributes$for('starting')
									]),
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text('Startbelopp')
									])),
								A2(
								$rtfeldman$elm_css$Html$Styled$input,
								_List_fromArray(
									[
										...
										$rtfeldman$elm_css$Html$Styled$Attributes$step('1000'),
										$author$project$Main$intValue(model.start),
										$rtfeldman$elm_css$Html$Styled$Events$onInput(
										function (v) {
											return $author$project$Main$UpdateStartbelopp(
												$author$project$Main$defaultToZero(v));
										})
									]),
								_List_Nil),
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text(
										$elm$core$String$fromInt(model.start))
									]))
							])),
						A2(
						$rtfeldman$elm_css$Html$Styled$div,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$Attributes$for('years')
									]),
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text('Antal år')
									])),
								A2(
								$rtfeldman$elm_css$Html$Styled$input,
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$Attributes$type_('range'),
										$rtfeldman$elm_css$Html$Styled$Attributes$min('0'),
										$rtfeldman$elm_css$Html$Styled$Attributes$max('20'),
										$rtfeldman$elm_css$Html$Styled$Attributes$step('1'),
										$author$project$Main$intValue(model.years),
										$rtfeldman$elm_css$Html$Styled$Events$onInput(
										function (v) {
											return $author$project$Main$UpdateYears(
												$author$project$Main$defaultToZero(v));
										})
									]),
								_List_Nil),
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text(
										$elm$core$String$fromInt(model.years))
									]))
							]))
					])),
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Main$Share)
							]),
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text('Dela!')
							])),
						A2(
						$rtfeldman$elm_css$Html$Styled$button,
						_List_fromArray(
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text('Återställ!')
							]))
					]))
			]));
};
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"UpdateYearlyInterest":["Basics.Int"],"UpdateMonthlySavings":["Basics.Int"],"UpdateStartbelopp":["Basics.Int"],"UpdateYears":["Basics.Int"],"Share":[],"Reset":[],"UrlRequested":["Browser.UrlRequest"],"UrlChanged":["Url.Url"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}}}}})}});}(this));